...
Read the issue, codebase, and exactly these issue comments: `plan-requirements`, `plan-architecture`, `plan-risks`, and `spec-final`. Verify their markers exist before proceeding. Attack the synthesized spec from a falsification perspective.
