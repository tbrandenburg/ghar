...
Require the issue comments with these exact HTML tags: `<!-- spec-approved -->`, `<!-- implementation-review-findings -->`, `<!-- maintainer-review-findings -->`, `<!-- adversarial-review-findings -->`, `<!-- residual-gap-findings -->`, and `<!-- ci-evidence -->`. Fetch and check out the latest shared branch. Read the issue plus those tagged comments. Derive todos from all review inputs. Create todos for every high and critical finding. Solve all reported review findings.
