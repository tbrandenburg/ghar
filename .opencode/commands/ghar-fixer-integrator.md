...
Use the PR head SHA as the source of truth. Do not rely on workflow names.
If no workflow runs or check runs exist for the SHA, the PR was likely created without scheduling CI.
